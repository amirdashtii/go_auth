...
// NewMockInMemoryRespositoryContracts creates a new instance of MockInMemoryRespositoryContracts. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockInMemoryRespositoryContracts(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockInMemoryRespositoryContracts {
	mock := &MockInMemoryRespositoryContracts{}
	mock.Mock.Test(t)
...
// MockInMemoryRespositoryContracts is an autogenerated mock type for the InMemoryRespositoryContracts type
type MockInMemoryRespositoryContracts struct {
	mock.Mock
}
...
func (_m *MockInMemoryRespositoryContracts) EXPECT() *MockInMemoryRespositoryContracts_Expecter {
	return &MockInMemoryRespositoryContracts_Expecter{mock: &_m.Mock}
}

// AddToken provides a mock function for the type MockInMemoryRespositoryContracts
func (_mock *MockInMemoryRespositoryContracts) AddToken(ctx context.Context, userID string, token string, expiration time.Duration) error {
...
// FindToken provides a mock function for the type MockInMemoryRespositoryContracts
func (_mock *MockInMemoryRespositoryContracts) FindToken(ctx context.Context, userID string) (string, error) {
...
// RemoveToken provides a mock function for the type MockInMemoryRespositoryContracts
func (_mock *MockInMemoryRespositoryContracts) RemoveToken(ctx context.Context, userID string) error {
	ret := _mock.Called(ctx, userID)

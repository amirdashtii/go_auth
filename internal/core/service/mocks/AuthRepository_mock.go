...
func (_mock *MockAuthRepository) Create(ctx context.Context, user *entities.User) error {
...
func (_mock *MockAuthRepository) FindUserByID(ctx context.Context, id uuid.UUID) (*entities.User, error) {
...
// FindUserByPhoneNumber provides a mock function for the type MockAuthRepository
func (_mock *MockAuthRepository) FindUserByPhoneNumber(ctx context.Context, phoneNumber *string) (*entities.User, error) {
